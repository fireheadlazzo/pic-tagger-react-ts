...
class checkRequiredKeys {
  imagePOST(req: Request & UploadRequest, res: Response, next: NextFunction) {
  ...
  tagPOST(req: Request, res: Response, next: NextFunction) {
...
export default new checkRequiredKeys;